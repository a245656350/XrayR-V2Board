...
install_XrayR() {
    ...
    # Writing json
    echo "正在尝试写入配置文件..."
    wget https://cdn.jsdelivr.net/gh/a245656350/XrayR-V2Board/config.yml -O /etc/XrayR/config.yml
    ...
    echo "Telegram: https://t.me/a245656350"
    echo "Github: https://github.com/a245656350/XrayR-V2Board"
